...
vector<Token> ShuntingYard::reversePolishNotation(vector<Token> Expression)
{
    ...
    m_Expression.push_back(Token(Token::Key::Parentheses, string(1, PARENTHSESE_OPEN), m_Expression.at(m_Expression.size() - 1).lineIndex()));
